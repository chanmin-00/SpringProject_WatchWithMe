...
public class MemberController {
     ...
     */
    @PostMapping("/token")
    public ApiResponse<LoginResponseDto> authorize(@RequestBody LoginRequestDto loginRequestDto) {
     ...
     */
    @PostMapping
    public ApiResponse<Long> join(@RequestBody SignUpRequestDto signUpRequestDto) {
        Long memberId;
